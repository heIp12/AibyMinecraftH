...
## H. 결정 필요 (코드 적용 전)
- **D-1 (CODE-3):** 사망 캐리어 보상 이관 방식 — 유산 포인트 / 다음 캐릭터 이월 / 다음 스테이지 1회 추가 특성 선택권?
- **D-2 (P66/CODE-17):** S등급 "타임라인 2단계 이하"를 변동 단계에서 어떻게 — "전체 단계의 절반(올림) 이하" 권장?
- **D-3:** 적용 범위/순서 — 프롬프트만 먼저 vs 프롬프트+코드(HIGH) 동시?

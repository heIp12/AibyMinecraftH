    ...
    public String restyleDialogue(String dialogue, String styleSpec) {
        ...
        try {
            String sys = "너는 '대사 말투 변환기'다. 아래 [원본 대사]의 ★내용·정보·의미·감정·문장 수·괄호 지문(예: (문을 밀며))·줄바꿈·문장부호는 조금도 바꾸지 말고★, "
                ...
                + "⑥★이중 종결어미 중첩 금지★: 지정 어미로 맺을 땐 원래 문장의 표준 종결어미를 ★교체★하라 — 그 위에 덧대어 종결어미가 둘 겹치게(이중 종결어미) 하지 마라(예: '왔어요'에 '~라니까'를 얹어 '왔어요라니까'로 겹치지 말고 '왔다니까'로 교체). ★단 [스타일]이 지정한 어미 자체가 이중 형태(예: '~다에요'='다'+'에요', '~거에요')면 그 이중형이 ★목표 형태★이니 예외 — 스타일대로 맺어라(그건 겹침이 아니라 그 말투의 매력이다). "

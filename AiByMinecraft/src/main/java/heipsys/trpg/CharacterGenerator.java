...
- description: 캐릭터가 살아오며 쌓인 내면적 능력/경향/약점을 자연스러운 서사로 묘사 (2~3문장)
- 수동 특성(active:false)의 effect: "판정 상황에서 자연스럽게 발휘됩니다." 같은 자연스러운 문장으로
- 능동 특성(active:true)의 effect: 구체적 사용 효과를 명확하게 서술
...
""";
    ...
    private List<TraitData> staticFallbackTraits(PlayerData pd) {
        ...
        String[][] pos = {
            {"강인한 신체", "C", "웬만한 충격에도 쉽게 무너지지 않는 단단한 체력을 지니고 있다. 힘든 상황에서도 버텨내는 끈기가 있다.", "어려운 상황에서도 쉽게 쓰러지지 않습니다."},
            {"다져진 근육", "C", "평소 신체를 자주 사용하는 생활 속에서 자연스럽게 길러진 힘이다. 무거운 것을 다루거나 몸으로 버텨야 할 때 빛을 발한다.", "힘이 필요한 상황에서 유리하게 작용합니다."},
            {"냉정한 심성", "C", "어지간한 충격에도 이성의 끈을 놓지 않는다. 혼란스러운 상황일수록 오히려 차분해지는 경향이 있다.", "공포나 혼란 상황에서 버텨낼 때 유리하게 작용합니다."},
            {"자연스러운 친화력", "C", "낯선 사람과도 금방 거리를 좁히는 타고난 사교성이 있다. 분위기를 부드럽게 만드는 말 한마디를 자연스럽게 꺼낸다.", "대인 관계가 필요한 상황에서 유리하게 작용합니다."},
            {"행운아", "C", "어쩐지 결정적인 순간에 운이 따라주는 편이다. 스스로도 왜인지 모르겠지만, 위기의 순간마다 작은 행운이 찾아온다.", "예상치 못한 행운이 발생할 가능성이 높아집니다."},
            {"날카로운 직감", "C", "눈에 보이지 않는 것을 감지하는 직관이 발달해 있다. 분위기가 이상하다거나, 뭔가 틀렸다는 느낌을 남들보다 빨리 캐치한다.", "상황의 낌새를 빠르게 눈치채는 데 유리합니다."}
        };
        String[][] neg = {
            {"허약한 체력", "F", "조금만 무리해도 금방 지치는 편이다. 체력 소모가 많은 상황에서는 다른 사람보다 먼저 한계에 도달하곤 한다.", "체력 소모가 많은 상황에서 불리하게 작용합니다."},
            {"약한 팔다리", "F", "힘이 부족해 무거운 것을 다루기가 힘들다. 몸으로 부딪혀야 하는 상황에서 특히 약점이 드러난다.", "힘이 필요한 상황에서 불리하게 작용합니다."},
            {"예민한 신경", "F", "충격적인 장면이나 극한의 상황에 매우 취약한 편이다. 공포나 충격 앞에서 냉정함을 잃기 쉬운 성격이다.", "공포나 혼란 상황에서 정신력 유지가 더 어렵습니다."},
            {"낮은 친화력", "F", "낯선 사람과 어울리는 데 많은 에너지가 필요하다. 처음 보는 상대와의 대화나 협력이 유독 버겁게 느껴진다.", "대인 관계가 필요한 상황에서 불리하게 작용합니다."},
            {"불운한 경향", "F", "작은 실수가 연쇄적으로 이어지는 경험을 자주 한다. 운이 따라주지 않는 순간이 꽤 많다는 느낌이 늘 있다.", "예상치 못한 불운이 발생할 가능성이 높아집니다."},
            {"무딘 감각", "F", "주변 상황의 변화를 남들보다 늦게 눈치채는 편이다. 뭔가 이상하다는 느낌을 받아도 정확히 짚어내기까지 시간이 걸린다.", "상황의 낌새를 파악하는 데 불리합니다."}
        };

...
1. ★완급(사건 리듬)★: 큰 본선 사건 사이사이에 ★작은 곁가지 사건(side:true)★을 끼워라 — 분위기 환기·자원 소모·짧은 선택. 모든 사건이 하나의 큰 줄기로만 이어질 필요 없다.
...
## 출력 JSON 스키마
{
  ...
  "timeline": {
    ...
    "main_events": [
      ...
      {"id":"E1b","time":"15:30","label":"","effect":"","side":true},
      // ↑ side:true = 본선과 별개의 작은 곁가지 사건(완급). 큰 사건들 사이에 1~2개 끼워라.

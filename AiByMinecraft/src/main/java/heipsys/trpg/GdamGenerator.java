...
- ★세대차 관계는 나이차를 지켜라★: 부모-자식·조부모-손주처럼 세대가 다른 관계는 연장자가 아래보다 ★최소 18살 이상★ 많아야 한다(엄마 42·딸 40 같은 불가능한 조합 금지). ★플레이어끼리는 나이가 비슷하게 앵커되므로(위 나이 앵커) 플레이어↔플레이어에는 세대차 관계를 만들지 마라★ — 형제·자매·부부·연인·친구·사촌·동창·동료 같은 또래 관계로. 부모-자식·조손 등 세대차 관계가 필요하면 ★플레이어↔NPC★로 맺고 그 NPC 나이를 세대차만큼 벌려라(age로 명시하거나 서술로).

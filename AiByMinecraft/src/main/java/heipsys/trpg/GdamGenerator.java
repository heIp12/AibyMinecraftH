...
4. ★상호 정합(양방향) 필수★: 괴담→스토리 일방 파생으로 끝내지 말고, 파생한 무대·배역·사건이 ★컨셉(주제·설정)과도 서로 맞물리는지★ 되짚어라 — 컨셉에 맞춰 괴담의 '표현·연출'을 다듬고, 괴담에 맞춰 컨셉을 구체화해 ★둘이 한 몸처럼★ 정합하게 하라(괴담과 컨셉 어느 한쪽이 겉돌면 실패).
